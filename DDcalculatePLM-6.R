...
#pooling <- plm(Return24months ~ RSS+ #no result
#                 RSS*pTurnover+
#                 pROA+pLev+pProfit+pTobinQ+prisk+pilliquid+pTurnover+pspread+SplitRatio,  
#               data=PmyData,  model="pooling")
#summary(pooling)

#pooling <- plm(Return24months ~ L5H5+L5L5+H5H5+ #no result
#                 pROA+pLev+pProfit+pTobinQ+prisk+pilliquid+pTurnover+pspread+SplitRatio,  
#               data=PmyData,  model="pooling")
#summary(pooling)


############ has result for below both not significant in my story
#pooling <- plm(Return24months ~ RSS+ RSS*pilliquid + # has result
#                 pROA+pLev+pProfit+pTobinQ+prisk+pilliquid+pTurnover+pspread+SplitRatio,  
#               data=PmyData,  model="pooling")
#summary(pooling)
#pooling <- plm(Return24months ~ RSS+ RSS*pspread +# has result
#                 pROA+pLev+pProfit+pTobinQ+prisk+pilliquid+pTurnover+pspread+SplitRatio,  
#               data=PmyData,  model="pooling")
#summary(pooling)

#pooling <- plm(Return24months ~ L5L5+L5L5*pTurnover+  #no result
#                 L5H5+L5H5*pTurnover+
#                 H5H5+H5H5*pTurnover+
#                 pROA+pLev+pProfit+pTobinQ+prisk+pilliquid+pTurnover+pspread+SplitRatio,  
#               data=PmyData,  model="pooling")
...
#pooling <- plm(Return24months ~ L5L5+L5L5*pilliquid+  #has slight reverse result
#                 L5H5+L5H5*pilliquid+
#                 H5H5+H5H5*pilliquid+
#                 pROA+pLev+pProfit+pTobinQ+prisk+pilliquid+pTurnover+pspread+SplitRatio,  
#               data=PmyData,  model="pooling")
...
#pooling <- plm(Return24months ~ L4L4+L4L4*pilliquid+  #has no result
#                 L4H4+L4H4*pilliquid+
#                 H4H4+H4H4*pilliquid+
#                 pROA+pLev+pProfit+pTobinQ+prisk+pilliquid+pTurnover+pspread+SplitRatio,  
#               data=PmyData,  model="pooling")
...
#pooling <- plm(Return24months ~ L6L6+L6L6*pilliquid+  #has result but not significnt in my story
#                 L6H6+L6H6*pilliquid+
#                 H6H6+H6H6*pilliquid+
#                 pROA+pLev+pProfit+pTobinQ+prisk+pilliquid+pTurnover+pspread+SplitRatio,  
#               data=PmyData,  model="pooling")
...
#pooling <- plm(Return24months ~ L5L5+L5L5*X_turnover+  #no result
...
#pooling <- plm(D_Return24months ~ RSS+ RSS*D_pTurnover +  # RSS and turnover has result but not in line with story
#                 D_pROA+D_pLev+D_pProfit+ D_pTobinQ+ D_prisk+D_pilliquid+D_pTurnover +D_pspread+SplitRatio, 
#               data=PmyData,  model="pooling")
#summary(pooling)

#pooling <- plm(D_Return24months ~ L5L5+L5L5*D_pTurnover+  # L5H5 has stronger reverse effect result *** Best result
...
#pooling <- plm(D_Return24months ~ L5L5+L5L5*D_prisk+  # has no result on D_prisk, D_pspread, D_pTobinQ
#                 L5H5+L5H5*D_prisk+
#                 H5H5+H5H5*D_prisk+
#                 D_pROA+D_pLev+D_pProfit+ D_pTobinQ+ D_prisk+D_pilliquid+D_pTurnover +D_pspread+SplitRatio, 
#               data=PmyData,  model="pooling")
...
#               data=PmyData,  model="pooling")
#summary(pooling)
pooling <- plm(D_Return24months ~ RSS+RSS*DD_turnover+  #has stronger reverse effect
                 DD_ROA+DD_lev+DD_profit+DD_tobinq+DD_risk+DD_illiquid+DD_turnover+ DD_spread+SplitRatio,  
               data=PmyData,  model="pooling")
summary(pooling)
pooling <- plm(D_Return24months ~ L5L5+L5L5*DD_turnover+  #has stronger reverse effect
...
#               data=PmyData,  model="pooling")
#summary(pooling)
pooling <- plm(D_Return24months ~ RSS+RSS*DD_risk+  #has stronger reverse effect
                 DD_ROA+DD_lev+DD_profit+DD_tobinq+DD_risk+DD_illiquid+DD_turnover+ DD_spread+SplitRatio,  
               data=PmyData,  model="pooling")
summary(pooling)

pooling <- plm(D_Return24months ~ L5L5+L5L5*DD_risk+  #has stronger reverse effect
                 L5L5+L5L5*DD_risk+
                 L5H5+L5H5*DD_risk+
                 H5H5+H5H5*DD_risk+
                 DD_ROA+DD_lev+DD_profit+DD_tobinq+DD_risk+DD_illiquid+DD_turnover+ DD_spread+SplitRatio,  
...
pooling <- plm(D_Return24months ~ RSS+RSS*DD_illiquid+  #has stronger reverse effect
                 DD_ROA+DD_lev+DD_profit+DD_tobinq+DD_risk+DD_illiquid+DD_turnover+ DD_spread+SplitRatio,  
               data=PmyData,  model="pooling")
summary(pooling)

pooling <- plm(D_Return24months ~ L5L5+L5L5*DD_illiquid+  #has stronger reverse effect
                 L5L5+L5L5*DD_illiquid+
                 L5H5+L5H5*DD_illiquid+
                 H5H5+H5H5*DD_illiquid+
                 DD_ROA+DD_lev+DD_profit+DD_tobinq+DD_risk+DD_illiquid+DD_turnover+ DD_spread+SplitRatio,  
               data=PmyData,  model="pooling")
summary(pooling)
...
pooling <- plm(D_Return24months ~ RSS+ DD_NII2Q+   #has stronger reverse effect
                 DD_ROA+DD_lev+DD_profit+DD_tobinq+DD_risk+DD_illiquid+DD_turnover+ DD_spread+SplitRatio,  
               data=PmyData,  model="pooling")
...
pooling <- plm(D_Return24months ~ RSS+ DD_LNII2Q+   #has stronger reverse effect
                 RSS*DD_LNII2Q+
                 DD_ROA+DD_lev+DD_profit+DD_tobinq+DD_risk+DD_illiquid+DD_turnover+ DD_spread+SplitRatio,  
               data=PmyData,  model="pooling")

summary(pooling)
pooling <- plm(D_Return24months ~ DD_LNII2Q+  #has stronger reverse effect
                 L5L5+L5L5*DD_LNII2Q+
                 L5H5+L5H5*DD_LNII2Q+
                 H5H5+H5H5*DD_LNII2Q+
                 DD_ROA+DD_lev+DD_profit+DD_tobinq+DD_risk+DD_illiquid+DD_turnover+ DD_spread+SplitRatio,  
...
pooling <- plm(D_Return24months ~ RSS+ DD_LPSH2Q+   #has stronger reverse effect
                 RSS*DD_LPSH2Q+
                 DD_ROA+DD_lev+DD_profit+DD_tobinq+DD_risk+DD_illiquid+DD_turnover+ DD_spread+SplitRatio,  
               data=PmyData,  model="pooling")
...
pooling <- plm(D_Return24months ~ DD_LPSH2Q+  #has stronger reverse effect
                 L5L5+L5L5*DD_LPSH2Q+
                 L5H5+L5H5*DD_LPSH2Q+
                 H5H5+H5H5*DD_LPSH2Q+
                 DD_ROA+DD_lev+DD_profit+DD_tobinq+DD_risk+DD_illiquid+DD_turnover+ DD_spread+SplitRatio,  
